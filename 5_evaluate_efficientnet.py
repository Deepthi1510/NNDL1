...
print("\nLoading saved model 'efficientnet_model.keras'...")
model = tf.keras.models.load_model('efficientnet_model.keras')

# 4. Generate Predictions
print("Evaluating on test patches (this may take a minute)...")
...
plt.imshow(cm, interpolation='nearest', cmap=plt.cm.Greens) # Swapped to Greens for EfficientNet!
plt.title('Confusion Matrix - EfficientNet Test Set')
plt.colorbar()
