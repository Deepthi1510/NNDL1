...
print("=========================================")
print("  TRAINING EFFICIENTNETB0 NEURAL NETWORK ")
print("=========================================\n")
...
# Load the pre-trained EfficientNet base
...
model = tf.keras.Sequential([
    # Note: EfficientNet handles 0-255 inputs natively, so no rescaling layer is needed here!
    base_model,
...
# --- 4. Train the Model ---
print("\nStarting Training! Let's see if it beats ResNet...\n")
history = model.fit(
    train_dataset,
...
print("\n✅ Model successfully saved as 'efficientnet_model.keras'")
